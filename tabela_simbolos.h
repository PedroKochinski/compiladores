...
struct expressao *nova_expressao_operador_aditivo_e_multiplicativo(
    FILE *fp, struct tabela_simbolos *ts, struct expressao *esq, struct expressao *dir, char *operador, int *contador_simbolos);
...
struct simbolo *busca_simbolo2(struct tabela_simbolos *ts, char *lexema, TipoSimbolo tipo);
