...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    REAL = 264,                    /* REAL  */
    OR = 265,                      /* OR  */
    OPERADOR_RELACIONAL = 266,     /* OPERADOR_RELACIONAL  */
    EOL = 267,                     /* EOL  */
    PONTO_FINAL = 268,             /* PONTO_FINAL  */
    VAR = 269,                     /* VAR  */
    FUNCTION = 270,                /* FUNCTION  */
    PROCEDURE = 271,               /* PROCEDURE  */
    DOIS_PONTOS = 272,             /* DOIS_PONTOS  */
    ...
    DO = 278,                      /* DO  */
    WHILE = 279,                   /* WHILE  */
    OPERADOR_ATRIBUICAO = 280,     /* OPERADOR_ATRIBUICAO  */
    ID = 281,                      /* ID  */
    NUM = 282,                     /* NUM  */
    OPERADOR_MULTIPLICATIVO = 283, /* OPERADOR_MULTIPLICATIVO  */
    MAIS = 284,                    /* MAIS  */
    MENOS = 285                    /* MENOS  */
  };
